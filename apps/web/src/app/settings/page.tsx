                ...
                <div className="divide-y divide-gray-100">
                  {section.items.map((item) => (
                    <button
                      key={item.label}
                      disabled
                      className="flex w-full items-center justify-between p-4 text-left cursor-not-allowed hover:bg-gray-50"
                    >
                      <div>
          ...
          <div className="mt-8 rounded-xl border border-red-200 bg-white opacity-50 grayscale">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between">
                ...
                <button
                  disabled
                  className="rounded-lg border border-red-300 px-4 py-2 text-sm font-medium text-red-600 cursor-not-allowed"
                >
                  Delete Account
                </button>
              </div>
