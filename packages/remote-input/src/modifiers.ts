...
// Translating the modifier *keypress* itself — a Cmd press arriving as a Super
// press — is `resolveKeyCode` in ./keymap.ts, which owns everything to do with
// turning a DOM code into a key this host can press.
