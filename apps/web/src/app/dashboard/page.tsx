...
const plans = [
  {
    ...
    features: ['2 participants', 'P2P connections', 'Screen sharing', 'Remote control'],
    current: true,
  },
  {
    name: 'Pro',
    ...
    features: ['Unlimited participants', 'SFU relay servers', 'Priority support', 'Analytics'],
    current: false,
  },
  {
    name: 'Team',
    ...
    features: ['Everything in Pro', 'Team management', 'SSO/SAML', 'Custom branding'],
    current: false,
  },
];
