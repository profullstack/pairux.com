...
export function DownloadSection() {
  ...
  const currentPlatform = detected ? getPlatformInfo(detected.os, detected.arch) : null;
        ...
        {currentPlatform && detected && detected.os !== 'unknown' && (
          <div className="mb-16">
            <div className="border-primary-200 bg-primary-50 mx-auto max-w-2xl rounded-2xl border p-8">
              <div className="flex items-center justify-center gap-3">
                <currentPlatform.icon className="text-primary-600 h-8 w-8" />
                <h2 className="text-2xl font-bold text-gray-900">{currentPlatform.name}</h2>
              </div>
              ...
              {currentPlatform.primary.command && (
                <div className="mt-6">
                  ...
                  <div className="mt-2 flex items-center gap-2 rounded-lg bg-gray-900 p-4 font-mono text-sm text-gray-100">
                    <span className="text-gray-500">$</span>
                    <code className="flex-1">{currentPlatform.primary.command}</code>
              ...
              {currentPlatform.secondary && (
                <div className="mt-6 text-center">
                  <Link
                    ...
                    className="text-primary-600 inline-flex items-center gap-2 text-sm hover:underline"
                  >
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-gray-200 p-6">
              ...
              <div className="mt-6 space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700">Homebrew</label>
                  <div className="mt-1 flex items-center gap-2 rounded bg-gray-100 p-2 font-mono text-xs">
                    <code className="flex-1 truncate">brew install --cask pairux</code>
            ...
            <div className="rounded-xl border border-gray-200 p-6">
              ...
              <div className="mt-6 space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700">WinGet</label>
                  <div className="mt-1 flex items-center gap-2 rounded bg-gray-100 p-2 font-mono text-xs">
                    <code className="flex-1 truncate">winget install PairUX.PairUX</code>
            ...
            <div className="rounded-xl border border-gray-200 p-6">
              ...
              <div className="mt-6 space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700">Debian/Ubuntu</label>
                  <div className="mt-1 flex items-center gap-2 rounded bg-gray-100 p-2 font-mono text-xs">
                    <code className="flex-1 truncate">sudo apt install pairux</code>
                    <CopyButton text="sudo apt install pairux" />
                  </div>
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700">Fedora/RHEL</label>
                  <div className="mt-1 flex items-center gap-2 rounded bg-gray-100 p-2 font-mono text-xs">
                    <code className="flex-1 truncate">sudo dnf install pairux</code>
                      ...
                      <tr key={filename} className="border-b border-gray-100 last:border-0">
                        ...
                        <td className="py-2">
                          <div className="flex items-center gap-2">
                            <code className="max-w-[200px] truncate text-gray-500 sm:max-w-none">
                              {hash}
                            </code>
