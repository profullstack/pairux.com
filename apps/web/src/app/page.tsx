...
const features = [
  ...
  },
  {
    ...
    description:
      'End-to-end encrypted via WebRTC DTLS-SRTP. Media never touches our servers.',
  },
  {
    icon: Globe,
    title: 'PWA Viewer',
    description:
      'Join sessions from any browser. No downloads required for viewers.',
  },
  {
    icon: Cpu,
          ...
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
            <div className="text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600 sm:text-xl">
                Collaborative screen sharing with simultaneous remote mouse and
                keyboard control. Like Screenhero, but open source.
              </p>
              <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Link
                  href="/download"
                  className="flex items-center gap-2 rounded-lg bg-primary-600 px-6 py-3 text-base font-semibold text-white shadow-lg transition-all hover:bg-primary-700 hover:shadow-xl"
                >
                  Download for Free
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
                Built for developers, designers, and anyone who needs to work
            ...
            <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="group relative rounded-2xl border border-gray-200 bg-white p-8 transition-all hover:border-primary-200 hover:shadow-lg"
                >
              ...
              {steps.map((step, index) => (
                <div key={step.number} className="relative">
                  ...
                  {index < steps.length - 1 && (
                    <div className="absolute left-1/2 top-16 hidden h-0.5 w-full bg-primary-200 lg:block" />
                  )}
                  <div className="relative flex flex-col items-center text-center">
                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary-600 text-2xl font-bold text-white shadow-lg">
                      {step.number}
                    </div>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-lg text-gray-600">
                  PairUX is built with security at its core. Your screen data
                  never touches our servers.
                </p>

                <ul className="mt-8 space-y-4">
                  <li className="flex items-start gap-3">
                    <Shield className="mt-0.5 h-6 w-6 flex-shrink-0 text-accent-600" />
                    <div>
                      <strong className="font-semibold text-gray-900">
                        End-to-End Encryption
                      </strong>
                      <p className="text-gray-600">
                        All media encrypted via WebRTC DTLS-SRTP
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Lock className="mt-0.5 h-6 w-6 flex-shrink-0 text-accent-600" />
                    <div>
                      <strong className="font-semibold text-gray-900">
                        Explicit Consent
                      </strong>
                      <p className="text-gray-600">
                        Host must approve all control requests
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Zap className="mt-0.5 h-6 w-6 flex-shrink-0 text-accent-600" />
                    <div>
                      <strong className="font-semibold text-gray-900">
                        Emergency Revoke
                      </strong>
                  ...
                  <li className="flex items-start gap-3">
                    <RefreshCw className="mt-0.5 h-6 w-6 flex-shrink-0 text-accent-600" />
                    <div>
                      <strong className="font-semibold text-gray-900">
                        Open Source
                      </strong>
                      <p className="text-gray-600">
                        Fully auditable code under MIT license
                      </p>
                    </div>
                  </li>
                </ul>
              ...
              <div className="relative">
                <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary-100 to-accent-100 p-8">
                  <div className="flex h-full flex-col items-center justify-center rounded-xl border-2 border-dashed border-primary-300 bg-white/50">
                    <Lock className="h-16 w-16 text-primary-600" />
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg text-primary-100">
                Download PairUX and start sharing your screen in seconds.
                Free, open source, and privacy-focused.
              </p>
              <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Link
                  href="/download"
                  className="flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-base font-semibold text-primary-600 shadow-lg transition-all hover:bg-primary-50 hover:shadow-xl"
                >
                  Download Now
                  <ArrowRight className="h-5 w-5" />
                </Link>
                <Link
                  href="/features"
                  className="flex items-center gap-2 rounded-lg border border-primary-400 px-6 py-3 text-base font-semibold text-white transition-all hover:bg-primary-500"
                >
                  Learn More
                </Link>
              </div>
